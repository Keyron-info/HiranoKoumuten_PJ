    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-50 via-white to-orange-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 border border-gray-100">
          ...
          <div className="mt-6 p-4 bg-orange-50 rounded-lg border border-orange-200">
            ...
            <div className="space-y-1 text-xs text-orange-700">
              <p><span className="font-mono bg-white px-2 py-0.5 rounded">kyouryoku_test</span> / <span className="font-mono bg-white px-2 py-0.5 rounded">test1234</span> (協力会社)</p>
              <p><span className="font-mono bg-white px-2 py-0.5 rounded">genba_test</span> / <span className="font-mono bg-white px-2 py-0.5 rounded">test1234</span> (現場監督)</p>
            </div>
          </div>
        ...
        <p className="text-center text-xs text-gray-500">
          © 2025 KEYRON BIM. All rights reserved.
        </p>
      </div>
    </div>
  );
